...
var EurolandToolIntegrationObject = new (function() {
		...
		if(obj.iFrame) {
			if(typeof obj.iFrame.height == 'number') {
				if(typeof obj.iFrame.index == 'number' && iFrameArr.length > obj.iFrame.index) {
					iFrameArr[obj.iFrame.index].iFrame.height = obj.iFrame.height;
				}
			}
		}
	};
	...
	*/
		...
		iFrame.contentWindow.postMessage("ActivateEurolandToolAutoSizeObject-" + obj.index, '*');
	...
	*/
		...
		if(typeof iFrame != 'object' || !iFrame.nodeName || iFrame.nodeName.toLowerCase() != 'iframe')
			return;		
...
if (typeof jQuery == 'function') {
	(function ($) {
		...
		*/
		...
		$.fn.extend({
			EurolandIFrameAutoHeight : function() {
